...
from .gaussian_diffusion_utils import GaussianDiffusionSeg

@SEGMENTORS.register_module()
class GaussianDiffusionEncoderDecoder(BaseSegmentor,GaussianDiffusionSeg):
    ...
    def __init__(self,
        ...
        GaussianDiffusionSeg.__init__(self,**diffusion_cfg)
