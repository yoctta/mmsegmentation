    ...
    for batch_indices, data in zip(loader_indices, data_loader):
        if counter%world_size==rank:
            ...
            with torch.no_grad():
                ...
                uc_map=[resize(merge_fn(resize(temp_uc,model.test_cfg.crop_size,mode='bilinear',align_corners=model.align_corners))[:,:1],(ori_h, ori_w),mode='bilinear',align_corners=model.align_corners)]
